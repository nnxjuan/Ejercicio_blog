...
--
-- Database: fork-ej-21
-- Generation Time: 2023-02-16 10:40:16.9300
-- -------------------------------------------------------------
...
(14, 'Hola!', 'Articulo nuevo. Con pocas palabras para ser un articulo.', '10f04a45685dfc257065f2100.jpeg', '2023-02-13', NULL, 1),
...
(21, 'este es el titulo modificado con permiso', 'ahora marta solo puede modificar los articulos que le pertenen', '9c1c77e4b3ae89589d6537b00.jpg', '2023-02-15', NULL, 5);

INSERT INTO `authors` (`id`, `firstname`, `lastname`, `email`, `password`, `username`) VALUES
(1, 'Marcus', 'Fisher', 'marcus@gmail.com', NULL, NULL),
(2, 'Pedro', 'Perez', 'pedro@gmail.com', NULL, NULL),
(3, 'Cristina', 'Racedo', 'chevi.racedo@gmail.com', '$2a$10$qrAbYPbpLN5L7gV48veWhO7qlI/L0U1Us8doq7utG6bonp.J.T9R2', NULL),
(4, 'maria', 'pereira', 'pedroracedo564@gmail.com', '$2a$10$hxr0e/z72.cdsRaaeOI9UOwagS3UKmXU6gjTeJ.Txx3TZ6Tx0UGZG', NULL),
(5, 'marta', 'perez', 'pedroracedo564@gmail.com', '$2a$10$hNdhPpYLisFXGbtOYnWE7OONJ2OPsA/hEZOdVBs9VIvI0SSyj9Y1y', 'marper'),
(6, 'carlos', 'carlos', 'carlos@gmail.com', '$2a$10$t7B4rHHb./g1px8GAKGnN.5qYgr01I/I/Jq4ULZaX.u9cnbVA2hwK', 'carlos');

INSERT INTO `comments` (`id`, `text`, `name`, `articleId`, `date`) VALUES
(9, 'Hola!', 'Juan Francisco Nanio', NULL, '2023-02-11'),
(10, 'ghghjfjgfjgfjgfjg', 'jose', NULL, '2023-02-12'),
(11, 'Muy bueno!', 'Juan', NULL, '2023-02-13'),
(12, 'Hola!', 'Juan Francisco Nanio', 14, '2023-02-13'),
(13, 'Muy bueno!', 'Jose', 14, '2023-02-13'),
(14, 'eeeeeeeeeeeeee eeeeeeeee', 'lnjhhgfg lkjhuyftrd uftrsres', NULL, '2023-02-15'),
(15, 'wertyuuiopkjhgf', 'wer', NULL, '2023-02-15'),
(16, 'la queja', 'el nombre', NULL, '2023-02-15'),
(17, 'aca es donde la gente se queja de la gente que escribe articulos en este blog', 'mario miguel', NULL, '2023-02-15'),
(18, 'carlos', 'carlos carlos', 4, '2023-02-15'),
(19, 'ahshjathgaft', 'marta', 21, '2023-02-16');
