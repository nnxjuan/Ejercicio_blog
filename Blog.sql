...
--
-- Database: Blog
-- Generation Time: 2023-02-11 14:38:33.2380
-- -------------------------------------------------------------
...
CREATE TABLE `articles` (
  ...
  CONSTRAINT `articles_commentId_foreign_idx` FOREIGN KEY (`commentId`) REFERENCES `comments` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
